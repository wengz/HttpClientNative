...
#ifndef HTTPCLIENTNATIVE_HTTPURL_H
#define HTTPCLIENTNATIVE_HTTPURL_H
   ...
   */
       ...
       */
        ...
        static string canonicalize(const string &input, int pos, int limit, const string encode_set,
                                   bool alreadyEncoded, bool strict, bool plusIsSpace,
                                   bool asciiOnly);
...
/**
   ...
   */
       ...
       *
       */
        static HttpUrl get(const string &url);
...
#endif //HTTPCLIENTNATIVE_HTTPURL_H
